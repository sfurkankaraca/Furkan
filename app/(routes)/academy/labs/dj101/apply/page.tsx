...
export default function ApplyDj101Page() {
  const [busy, setBusy] = useState(false);
  const [done, setDone] = useState(false);
  const kind = "dj101" as const;
  ...
  return (
    <Section title="DJ 101 Başvuru" description="Kısa formu doldur, seni arayalım.">
      <form onSubmit={submit} className="grid gap-4 max-w-2xl mx-auto">
        ...
        <div className="grid gap-3 rounded-xl border border-white/10 p-3">
          ...
          <label className="grid gap-2">
            <span className="text-sm text-white/80">Bu programa neden katılmak istiyorsun?</span>
        ...
        <div className="grid gap-3 rounded-xl border border-white/10 p-3">
          ...
          <div className="grid gap-2">
            <span className="text-sm text-white/80">Ders ne zaman olsa sana uyar?</span>
            <div className="grid gap-2 text-sm text-white/80">
