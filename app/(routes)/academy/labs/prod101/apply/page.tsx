    ...
    <Section title="Production 101 Başvuru" description="Kısa formu doldur, seni arayalım.">
      <form onSubmit={submit} className="grid gap-4 max-w-2xl mx-auto">
        ...
        <div className="grid gap-3 rounded-xl border border-white/10 p-3">
          <div className="text-sm text-white/80">Production 101 Soruları</div>
          ...
          <input name="q_beklenti" className="rounded-xl bg-black border border-white/20 px-3 py-2 text-white" placeholder="Programdan beklentin" />
        </div>
