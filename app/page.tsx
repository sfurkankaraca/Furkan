    ...
    <main>
      <section className="relative overflow-hidden">
        <div className="container mx-auto max-w-7xl px-4 py-16 md:py-24 grid md:grid-cols-2 items-center gap-10">
          <div>
            <h1 className="text-4xl md:text-6xl font-semibold tracking-tight">We are noqta.</h1>
            <p className="mt-4 text-lg text-white/70 max-w-prose">Kendini döngülerde hissedenler için bir sound collective.</p>
      ...
      <section>
        <div className="container mx-auto max-w-7xl px-4">
          <p className="text-white/70">We are noqta / A sound collective for people who feel in loops.</p>
